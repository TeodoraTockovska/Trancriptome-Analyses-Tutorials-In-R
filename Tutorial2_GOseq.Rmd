...
The proceeding steps is to explore the data, and figure out what the important GO terms are within the data. The goal of the final tutorial is to show you different methods to do this. Because the sample data did not have any significant GO terms, I cannot show you results, however, I will show you the typical things that you can explore. 
